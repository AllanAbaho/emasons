  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            ...
            <p>
              To empower our clients to achieve their business objectives through the integrated use of sustainable ICT
              solutions.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Professionalism and excellence in service delivery</li>
              <li><i class="ri-check-double-line"></i> Commitment to timely, quality and explicit work to ensure
                customer satisfaction</li>
              <li><i class="ri-check-double-line"></i> Honesty, integrity and transparency in our dealings</li>
              <li><i class="ri-check-double-line"></i> Trust and respect with our stakeholders, customers, suppliers,
                staff, shareholders and the community</li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              Emasons Uganda Limited is an information technology firm that has been operating since 2011. We offer
              various IT services but majorly focusing on Software development and Database Management.
            </p>
            <p>We operate and maintain highly specialized solutions that are supported by our uniquely qualified team of
              engineers, integrators and project managers. We provide a complete end to end service for IT development,
              support and maintenance. Ensuring that the client’s goals are achieved whilst maintaining the highest
              industry standards in an efficient and timely manner</p>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>These are some of the few services we provide.</p>
        </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            <h3>Need our help</h3>
            <p> Let us take care of your ICT and IT-Enabled Service needs while you focus on your core business or organisational works and services.</p>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>Here is a couple of projects and solutions we have provided to our clients recently.</p>
        </div>
    ...
    <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Team</h2>
          <p>Our team has a whole 15 years of combined experience in the tech industry.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-4">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="assets/img/team/team-0.jpg" class="img-fluid" alt=""></div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Feel free to reach out to us anytime via any of the available means.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Golf Course Road, Mariba
                  Building, 1st Floor Kololo</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>info@emasonsug.com</p>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <p>There are a couple of ways you can reach out to us.</p>
